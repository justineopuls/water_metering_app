...
class ViewDatabaseEntry extends StatelessWidget {
  const ViewDatabaseEntry({Key? key, required this.meterNumber, required this.uid}) : super(key: key);
      ...
      body: ListView(
        ...
        children: [
          ListTile(
            ...
            subtitle: const Text("View the listed account information.", style: TextStyle(
              fontSize: 12.5,),),
          ...
          ListTile(
            title: Text("Records"),
            subtitle: const Text("View the available records.", style: TextStyle(
              fontSize: 12.5,),),
